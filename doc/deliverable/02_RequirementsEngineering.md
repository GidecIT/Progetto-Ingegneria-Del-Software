...
| FR-11.1    | Il sistema deve consentire la ricerca testuale delle segnalazioni                                     | Media    | US-14         | La ricerca avviene sul titolo e sulla descrizione. Deve essere accessibile sia agli utenti registrati sia ai visitatori|
...
| FR-21   | Il sistema deve consentire agli amministratori di gestire gli account degli utenti                    | Alta     | US-18          | Le azioni possibili devono comprendere: sospendere, bannare, limitare temporaneamente o eliminare un account.|
...
| NFR-11 | Prestazioni          | Invio tempestivo delle notifiche email| Il 95% delle email consegnate al server SMTP entro 2 minuti dall'azione scatenante | Analisi automatizzata di log| Media    | Una comunicazione rapida è necessaria per mantenere alto engagement del cittadino|
