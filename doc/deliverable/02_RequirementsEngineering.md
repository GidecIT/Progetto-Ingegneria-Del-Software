...
| FR-5.1 | Il sistema deve consentire agli utenti registrati di effettuare un reset della password | media | US-02 | Se qualcuno non ricorda la password tramite un link email deve essere possibile resettarla  |
...
| FR-13.1 | Il sistema deve consentire ai cittadini di inserire le segnalazioni con opzione di anonimato|  alta |    US-12    | Deve essere possibile usare un opzione di anonimato così che  il cittadino possa decidere di contrassegnare una segnalazione come anonima ed in tal caso l'identità non è mostrata |
